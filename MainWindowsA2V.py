...
class MainWin(QWidget) :
    def __init__(self,shoot=True,title='Motors Control',configFile='configMoteurA2V.ini'):
        ...
        for vi in self.groups:
            ...
            self.motorListGui.append(oneMotorGuiNew.ONEMOTORGUI(mot=str(vi),motorTypeName='A2V'))
