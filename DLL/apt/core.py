...
class Motor(object):
    ...
    def move_to(self, value, blocking = False):
        ...
        blocking : bool
            ...
            Default: False
        """
        value = ctypes.c_float(value) # add by julien G
    ...
    def move_by(self, value, blocking = False):
        ...
        blocking : bool
            ...
            Default: False
        """
        value = ctypes.c_float(value) # add julien G
    ...
    def setPosition(self, value):
        pos = ctypes.c_float(value)
        err_code = _lib.MOT_SetPosition(self._serial_number,
                ctypes.byref(pos))
        if (err_code != 0):
            raise Exception("Getting position failed: %s" %
                    _get_error_text(err_code))
