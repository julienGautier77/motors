# -*- coding: utf-8 -*-
"""
Interface Graphique pour le pilotage de deux moteurs
...
if __name__ =='__main__':
    ...
    mot5=TWOMOTORGUI(motor0,'RSAI',motor1,'RSAI',nomWin='Cible',nomTilt='Cible Trans')
    mot5.show()
    mot5.startThread2()
    appli.exec_()
