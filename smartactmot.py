...
print('controller index', Controller_index)
...
class MOTORSMART():
    def __init__(self, mot1='',parent=None):
        ...
        print('i',self.numControleur)
        self.controller_index=Controller_index[self.numControleur]
        print(self.moteurname,self.controller_index,controller_index0)
    ...
    def getvelocity(self):
        ...
        Status=SMART.SA_GetClosedLoopMoveSpeed_S(self.controller_index,self.numMoteur,ctypes.pointer(velocity))
        
        print ("velocity ", self.moteurname, velocity.value,"nm/s",Status)
        return velocity.value

    

e=MOTORSMART(mot1='mot1')
print(e.position(),e.rmove(100000),e.getvelocity())
time.sleep(1)
print(e.position())
stopConnexion()